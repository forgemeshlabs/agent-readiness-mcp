...
`v0.1.0` is the first Agent Readiness namespace release: it includes the agent-friendly UX check, clarifies Google Search's generative AI guidance, and keeps Glama metadata ready.
